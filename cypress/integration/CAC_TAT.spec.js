...
describe('Central de Atendimento ao Cliente TAT', function() {
    ...
    it("exibe mensagem de erro quando o telefone se torna obrigatorio mas não é preenchido antes de envio do formulario ", function() {
    ...
    it('seleciona uma arquivo utilizando uma fixture para a qual foi dada um alias', function() {
